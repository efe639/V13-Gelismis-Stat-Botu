...
module.exports = {
     ...
     * @returns 
     */
    run: async (client, message, args, arvisbosEmbed, prefix) => {
        ...
        if (!args[0]) { return message.channel.send(arvisbosEmbed.setDescription(`
...
`)).then(() => message.react(config.emojis.red));
            ...
            if (role) {
                ...
                message.channel.send(arvisbosEmbed.setDescription(`
