...
module.exports = {
     ...
     * @param { MessageEmbed } arvisbosEmbed 
     * @returns
     */
    run: async (client, message, args, arvisbosEmbed) => {
        ...
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(config.targetAmount.vbronze)) {
            ...
            arvisbosEmbed.addField("❯ Ses Rozet Durumu:", `Üzgünüm dostum fakat bir rozete sahip değilsin. ${message.guild.roles.cache.get(config.badges.vbronze)} rozetini almak için public kanallarda \`${client.getTime(ms(config.targetAmount.vbronze) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
        }
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(config.targetAmount.vbronze) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(config.targetAmount.vsilver)) {
            if (!kullanıcı.roles.cache.has(config.badges.vbronze)) {
                ...
                arvisbosEmbed.addField("❯ Yeni Ses Rozeti!", `Tebrikler dostum! <a:arvisbos_surpriz:907973919795998720> Public kanallarda \`${client.getTime(ms(config.targetAmount.vbronze))}\` geçirerek **${message.guild.roles.cache.get(config.badges.vbronze)}** rozetini kazandın! Bir sonraki **${message.guild.roles.cache.get(config.badges.vsilver)}** rozetini elde etmek için public kanallarda \`${client.getTime(ms(config.targetAmount.vsilver) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
            } else {
                arvisbosEmbed.addField("❯ Ses Rozet Durumu:", `Tebrikler **${message.guild.roles.cache.get(config.badges.vbronze)}** rozetine sahipsin! Bir sonraki **${message.guild.roles.cache.get(config.badges.vsilver)}** rozeti elde etmek için public kanallarda \`${client.getTime(ms(config.targetAmount.vsilver) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
            }
        }
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(config.targetAmount.vsilver) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(config.targetAmount.vgold)) {
            if (!kullanıcı.roles.cache.has(config.badges.vsilver)) {
                ...
                arvisbosEmbed.addField("❯ Yeni Ses Rozeti!", `Tebrikler dostum! <a:arvisbos_surpriz:907973919795998720> Public kanallarda \`${client.getTime(ms(config.targetAmount.vsilver))}\` geçirerek **${message.guild.roles.cache.get(config.badges.vsilver)}** rozetini kazandın! Bir sonraki **${message.guild.roles.cache.get(config.badges.vgold)}** rozetini elde etmek için public kanallarda \`${client.getTime(ms(config.targetAmount.vgold) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
            } else {
        ...
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(config.targetAmount.vgold) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(config.targetAmount.vdia)) {
            if (!kullanıcı.roles.cache.has(config.badges.vgold)) {
                ...
                arvisbosEmbed.addField("❯ Yeni Ses Rozeti!", `Tebrikler dostum! <a:arvisbos_surpriz:907973919795998720> Public kanallarda \`${client.getTime(ms(config.targetAmount.vgold))}\` geçirerek **${message.guild.roles.cache.get(config.badges.vgold)}** rozetini kazandın! Bir sonraki **${message.guild.roles.cache.get(config.badges.vdia)}** rozetini elde etmek için public kanallarda \`${client.getTime(ms(config.targetAmount.vdia) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
            } else {
        ...
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(config.targetAmount.vdia) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(config.targetAmount.vemerl)) {
            if (!kullanıcı.roles.cache.has(config.badges.vdia)) {
                ...
                arvisbosEmbed.addField("❯ Yeni Ses Rozeti!", `Tebrikler dostum! <a:arvisbos_surpriz:907973919795998720> Public kanallarda \`${client.getTime(ms(config.targetAmount.vdia))}\` geçirerek **${message.guild.roles.cache.get(config.badges.vdia)}** rozetini kazandın! Bir sonraki **${message.guild.roles.cache.get(config.badges.vemerl)}** rozetini elde etmek için public kanallarda \`${client.getTime(ms(config.targetAmount.vemerl) - (pubVeriler ? pubVeriler.parentData : 0))}\` geçirmen gerekiyor.`);
            } else {
        ...
        if (parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(config.targetAmount.vemerl)) {
            if (!kullanıcı.roles.cache.has(config.badges.vemerl)) {
                ...
                arvisbosEmbed.addField("❯ Yeni Ses Rozeti!", `Tebrikler dostum! <a:arvisbos_surpriz:907973919795998720> Public kanallarda \`${client.getTime(ms(config.targetAmount.vemerl))}\` geçirerek **${message.guild.roles.cache.get(config.badges.vemerl)}** rozetini kazandın! Göstermiş olduğun emeklerden dolayı seni tebrik ediyorum! <a:arvisbos_kalp:895739415761133590>`);
            } else {
                arvisbosEmbed.addField("❯ Ses Rozet Durumu:", `Tebrikler dostum **${message.guild.roles.cache.get(config.badges.vemerl)}** rozetine sahipsin! Sen efsane birisin, emeklerin için çok teşekkürler. <a:arvisbos_kalp:895739415761133590>`);
            }
        }
        if (parseInt(messageData ? messageData.topStat : 0) < config.targetAmount.cbronze) {
            ...
            arvisbosEmbed.addField("❯ Mesaj Rozet Durumu:", `Üzgünüm dostum fakat bir rozete sahip değilsin. ${message.guild.roles.cache.get(config.badges.cbronze)} rozetini almak için sohbet kanallarına \`${config.targetAmount.cbronze - (messageData ? messageData.topStat : 0)}\` mesaj atman gerekiyor.`);
        }
        ...
        if (parseInt(messageData ? messageData.topStat : 0) > config.targetAmount.cemerl) {
            if (!kullanıcı.roles.cache.has(config.badges.cemerl)) {
                ...
                arvisbosEmbed.addField("❯ Mesaj Rozet Durumu:", `Tebrikler dostum **${message.guild.roles.cache.get(config.badges.cemerl)}** rozetine sahipsin! Sen efsane birisin, emeklerin için çok teşekkürler. <a:arvisbos_kalp:895739415761133590>`);
            }
        }
